...
Route::group(['middleware' => ['json.response']], function () {
    ...
    // private routes
    Route::middleware('auth:api')->group(function () {
        Route::post('/add-list-of-attendance-logs', 'Api\AttendanceLogController@addListOfAttendanceLogs');
        ...
        Route::get('/class-schedules/{classScheduleId}', 'Api\ClassScheduleController@show');
        ...
        Route::post('/cancel-transfer-order/{transferOrderId}','Api\TransferOrderController@cancelTransferOrder');
        ...
        Route::get('/gate-mode-types', 'Api\GeneralSettingController@gateModeTypes');
        ...
        Route::patch('/levels/{id}/restore', 'Api\LevelController@restore');
        Route::patch('/level-groups/{id}/restore', 'Api\LevelGroupController@restore');
        ...
        Route::get('/skating-aids/reset', 'Api\SkatingAidController@resetAllSkatingAid');

        Route::patch('/skating-aids/{id}/restore', 'Api\SkatingAidController@restore');
        ...
        Route::patch('/stocks/{id}/restore', 'Api\StockController@restore');
        Route::patch('/suppliers/{id}/restore', 'Api\SupplierController@restore');
        Route::patch('/supplier-addresses/{id}/restore', 'Api\SupplierAddressController@restore');
        Route::patch('/student-classes/{id}/cancel', 'Api\StudentClassController@cancel');
        
        Route::get('/student-classes/member/{memberId}', 'Api\StudentClassController@getClassesByMemberId');

        Route::put('/unattend-student/{classScheduleId}', 'Api\StudentAttendanceController@unattendStudent');
    ...
    Route::middleware('auth:api')->group(function () {
        ...
        Route::apiResource('/attendance-transactions', 'Api\AttendanceTransactionController');
        Route::apiResource('/attendance-logs', 'Api\AttendanceLogController');
        ...
        Route::apiResource('/coach-commissions', 'Api\CoachCommissionController');
        ...
        Route::apiResource('/student-attendances', 'Api\StudentAttendanceController');
