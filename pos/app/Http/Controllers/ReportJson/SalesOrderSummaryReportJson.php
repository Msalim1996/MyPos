...
use App\Http\Requests\Reports\SalesOrderSummaryRequest as StoreRequest;
use Illuminate\Http\Request;

class SalesOrderSummaryReportJson extends Controller
{
    public function index(StoreRequest $request)
    {
        ...
        $salesOrders = DB::select(DB::raw(
            ...
            SELECT
                ...
                sales_payments.amount as payment_amount,
                '' as sales_item_types,
                CASE
