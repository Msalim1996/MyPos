...
namespace App\Events\GateTicket;
...
class OnGoingTicketOutUpdateEvent implements ShouldBroadcast
{
    public $data;
    ...
    {
        return 'on.going.ticket.out.update';
    }
    ...
    {
        return new Channel('gate.ticket');
    }
}
