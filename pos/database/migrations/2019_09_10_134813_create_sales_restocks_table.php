...
class CreateSalesRestocksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sales_restocks', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('description')->nullable();
            $table->decimal('qty', 14, 6)->default(0);
            $table->datetime('restocked_date');
    ...
    {
        Schema::dropIfExists('sales_restocks');
    }
}
